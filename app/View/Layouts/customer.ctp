    ...
    <div class="navbar navbar-inverse navbar-static-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav">
				...
				<li><?php echo $this->Html->link('Order',['controller'=>'shop','action'=>'order']); ?></li>
                <li><?php echo $this->Html->link('Personal Information',['controller'=>'shop','action'=>'address']); ?></li>
				<li><?php echo $this->Html->link('Change Password',['controller'=>'users','action'=>'change_password']); ?></li>
				<li><?php echo $this->Html->link('Logout',['controller'=>'users','action'=>'logout', 'admin' => false]); ?></li>
            </ul>
        </div>
    </div>
