...
//////////////////////////////////////////////////
   ...
   public function customer_address() {
		...
		$data = $this->Address->query('select * from addresses where fr_user_id='.$this->Session->read('id'));
        if ($this->request->is('post')) {
            $this->loadModel('Order');
            $this->loadModel('Address');
            ...
            if($this->Address->validates()) {
                ...
                $address['order_type'] = 'creditcard';
                $this->Session->write('Shop.Order', $address + $shop['Order']);
        ...
        if(!empty($shop['Address'])) {
            $this->request->data['Address'] = $shop['Address'];
        }
