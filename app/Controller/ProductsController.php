...
////////////////////////////////////////////////////////////
    ...
    public function admin_add() {
        if ($this->request->is('post')) {
            ...
            $this->request->data['Product']['image'] = $uploadFileName;
            $user = $this->request->data;
            if ($this->Product->save($user)) {
                $dir = WWW_ROOT.'images/large/';
                $dir2 = WWW_ROOT.'images/small/';
                move_uploaded_file($file['tmp_name'], $dir.$uploadFileName);
                copy($dir.$uploadFileName,$dir2.$uploadFileName);
